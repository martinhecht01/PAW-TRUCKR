...
@Component
@Provider
public class CargoTypeNotFoundExceptionMapper implements ExceptionMapper<CargoTypeNotFoundException> {

    @Autowired
    private MessageSource messageSource;

    @Override
    public Response toResponse(CargoTypeNotFoundException exception) {

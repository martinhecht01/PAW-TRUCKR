...
@Component
@Provider
public class CuitAlreadyExistsExceptionMapper implements ExceptionMapper<CuitAlreadyExistsException> {

    @Autowired
    private MessageSource messageSource;

    @Override
    public Response toResponse(CuitAlreadyExistsException exception) {

...
<c:url var="verifyAccount" value="/verifyAccount"/>
<components:navBar/>
            ...
            <div class="card-body">
                <form:form modelAttribute="verifyAccountForm" action="${verifyAccount}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <form:errors cssClass="formError" path="token" element="p"/>
                        <form:input type="password" class="form-control" path="token" placeholder="Token"/>
                    </div>
                    <spring:message code="verifyAccount" var="value"/>

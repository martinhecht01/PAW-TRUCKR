    ...
    <div class="card-body">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>${request.departureDateString}</td>
            </tr>
            <tr>
...
<a href="<c:url value="/trips/manageTrip?tripId=${request.tripId}"/>" class="btn btn-color mt-3 formButton"><spring:message code="GoBack"/></a>

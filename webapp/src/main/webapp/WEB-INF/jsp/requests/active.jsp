...
<div class="tripCards w-75 justify-content-center m-auto">
  ...
  <c:forEach var="request" items="${requests}" varStatus="loop">
    <a class="text-decoration-none">
      ...
      <div class="card m-3" style="width: 25rem;">
        <ul class="list-group list-group-flush">
          <li class="list-group-item text-truncate"><b><spring:message code="Name"/>:</b> <c:out value="${providers[loop.index].name}"/></li>
          <li class="list-group-item text-truncate"><b><spring:message code="Email"/>:</b> <c:out value="${providers[loop.index].email}"/></li>
          <li class="list-group-item text-truncate"><b><spring:message code="Cuit"/>:</b> <c:out value="${providers[loop.index].cuit}"/></li>
        </ul>
      </div>
    </a>

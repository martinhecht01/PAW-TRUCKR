...
<form:form method="get">
  <div class="w-100 d-flex justify-content-end pt-5 pb-2 px-5">
    <c:if test="${activePublications.size() > 0}">
      <a class="btn btn-lg btn-color btn-outline-primary" href="<c:url value="/requests/create"/>"><spring:message code="CreatePublication"/></a>
    </c:if>
  </div>
        ...
        <div class="tripCards w-100 px-5 justify-content-center m-auto">
          <c:if test="${activePublications.size() == 0}">
            <div>
              ...
              <a class="mt-3 btn btn-lg btn-color btn-outline-primary" href="<c:url value="/requests/create"/>"><spring:message code="CreatePublication"/></a>
            </div>
          </c:if>

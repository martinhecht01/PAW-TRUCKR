        ...
        <c:forEach var="trip" items="${offers}">
          <a class="text-decoration-none" href="<c:url value="/trips/details?id=${trip.tripId}"/>">
            <div class="card m-3" style="width: 25rem;">
              ...
              <h4 class="mx-4 my-3 w-25 position-absolute top-0 end-0"><span class="badge rounded-pill text-bg-primary"><spring:message code="${trip.type}" htmlEscape="true"/></span></h4>
              <div class="card-body">

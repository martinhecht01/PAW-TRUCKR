...
public class TripServiceV2ImplTest {
    ...
    public void setup()
    {
        ...
        trip1 = new Trip(TRIPID_NOT_EXISTENT,user1, null, LICENSEPLATE_NOT_EXISTENT, WEIGHT_NOT_EXISTENT, VOLUME_NOT_EXISTENT, DEPARTUREDATE_NOT_EXISTENT, ARRIVALDATE_NOT_EXISTENT, ORIGIN_NOT_EXISTENT, DESTINATION_NOT_EXISTENT, TYPE_NOT_EXISTENT, PRICE_NOT_EXISTENT, false, false,null,null,0);
